          ...
          <div className="space-y-5">
            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-3">
                ...
                >
                  <div className={`w-10 h-10 rounded-full flex items-center justify-center ${
                    userRole === "admin" ? "bg-purple-100 text-purple-600" : "bg-gray-100 text-gray-500"
                  }`}>
                    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                    </svg>
                  </div>
                  <span className={`text-sm font-medium ${userRole === "admin" ? "text-purple-700" : "text-gray-700"}`}>
                    Admin
                  </span>
                ...
                >
                  <div className={`w-10 h-10 rounded-full flex items-center justify-center ${
                    userRole === "teacher" ? "bg-green-100 text-green-600" : "bg-gray-100 text-gray-500"
                  }`}>
                    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                    </svg>
                  </div>
                  <span className={`text-sm font-medium ${userRole === "teacher" ? "text-green-700" : "text-gray-700"}`}>
                    Teacher
                  </span>
