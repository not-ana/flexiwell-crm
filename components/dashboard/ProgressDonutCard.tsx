...
const COLORS = {
  pilates: { bg: "bg-primary-500", light: "bg-primary-100" },
  yoga: { bg: "bg-primary-400", light: "bg-primary-100" },
  reformer: { bg: "bg-primary-300", light: "bg-primary-100" },
  stretch: { bg: "bg-primary-600", light: "bg-primary-100" },
};
