  ...
  admin: {
    ...
    steps: [
      ...
      },
      {
        ...
        description: "In the Staff section, manage your instructors and admins. Add team members individually or import in bulk. Define their roles, send invitation emails, and track their performance metrics directly from the dashboard.",
        icon: (
          <svg className="w-8 h-8" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
